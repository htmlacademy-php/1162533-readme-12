            ...
            <div class="profile__user user container">
                ...
                <div class="profile__rating user__rating">
                    <p class="profile__rating-item user__rating-item user__rating-item--publications">
                        ...
                        ><?= get_noun_plural_form($user_info['count_posts'], 'публикация', 'публикации',
                                'публикаций') ?></span>
                    </p>
                    <p class="profile__rating-item user__rating-item user__rating-item--subscribers">
                        ...
                        <span
                                class="profile__rating-text user__rating-text"
                        ><?= get_noun_plural_form($user_info['count_followers'], 'подписчик', 'подписчика',
                                'подписчиков') ?></span>
                    </p>
                </div>
                                            ...
                                            <?php elseif ($post['content_type_title'] === 'post-video'): ?>
                                                <div class="post-video__block">
                                                    <div class="post-video__preview">
                                                        <?= embed_youtube_cover(htmlspecialchars($post['content']), 760,
                                                            393); ?>
                                                    </div>
                                            ...
                                            <?php if (!empty($hashtags)): ?>
                                                <ul class="post__tags">
                                                    <?php foreach ($hashtags as $hashtag): ?>
                                                        <li>
                                                            <a href="<?= $to('search',
                                                                ['search' => '%23' . $hashtag['title']]) ?>">#<?= $hashtag['title'] ?></a>
                                                        </li>
                                                    <?php endforeach; ?>
                                                </ul>
                                            <?php endif; ?>
                                        ...
                                        <li class="post-mini post-mini--photo post user">
                                            ...
                                            <div class="post-mini__rating user__rating">
                                                <p class="post-mini__rating-item user__rating-item user__rating-item--publications">
                                                    ...
                                                    ><?= get_noun_plural_form($subscription['post_count'], 'публикация',
                                                ...
                                                <p class="post-mini__rating-item user__rating-item user__rating-item--subscribers">
                                                    ...
                                                    <span class="post-mini__rating-text user__rating-text"
                                                    ><?= get_noun_plural_form($subscription['subscription_count'],
