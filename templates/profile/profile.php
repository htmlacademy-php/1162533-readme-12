...
<?= get_noun_plural_form($user_info['count_posts'], 'публикация', 'публикации', 'публикаций') ?>
                        </span>
                    </p>
                    <p class="profile__rating-item user__rating-item user__rating-item--subscribers">
                        <span class="user__rating-amount"><?= $user_info['count_followers'] ?></span>
                        <span class="profile__rating-text user__rating-text">
<?= get_noun_plural_form($user_info['count_followers'], 'подписчик', 'подписчика', 'подписчиков') ?>
                        </span>
                    </p>
                </div>
                ...
                <div class="profile__user-buttons user__buttons">
                    <?php if (!$is_your_profile) : ?>
                        ...
                        <?php else : ?>
                           ...
                           user__button
                           user__button--subscription
                           button button--main">Подписаться</a>
                        <?php endif; ?>
                    <?php endif; ?>
                </div>
            </div>
                                ...
                                <?php foreach ($user_posts as $post) : ?>
                                    <article class="profile__post post <?= $post['content_type_title'] ?>">
                                                    ...
                                                    >
                                                        ...
                                                        <div class="post__info">
                                                            <b
                                                                ...
                                                                Репост: <?= $post['origin_author_post'] ?></b>
                                                            <time
                                                                    class="post__time"
                                        ...
                                        <div class="post__main">
                                            <?php if ($post['content_type_title'] === 'post-photo') : ?>
                                                <div class="post-photo__image-wrapper">
                                                    <img src="<?= $post['content'] ?>" alt="Фото от пользователя"
                                            ...
                                            <div class="post__indicators">
                                                <div class="post__buttons">
                                                    <a href="<?= utils_url_to('likes', [
                                                       ...
                                                       title="Лайк">
                                                        <svg class="post__indicator-icon" width="20" height="17">
                                                            <use
                                                                xlink:href="/img/sprite.svg#<?= $check_is_liked_post($post['id']) ?>"
                                                            ></use>
                                                        </svg>
                                                    ...
                                                    <a
                                                            ...
                                                            href="<?= utils_url_to('repost', ['ID' => $post['id']]) ?>"
                                                            title="Репост">
                                                        <svg class="post__indicator-icon" width="19" height="17">
                                                            <use xlink:href="/img/sprite.svg#icon-repost"></use>
                                                        </svg>
                                            ...
                                            <?php if (!empty($hashtags)) : ?>
                                                <ul class="post__tags">
                                                    <?php foreach ($hashtags as $hashtag) : ?>
                                                        <li>
                                                            <a
                                                                href="<?= utils_url_to('search', [
                                                                    'search' => '%23' . $hashtag['title']
                                                                    ]) ?>"
                                                            >#<?= $hashtag['title'] ?></a>
                                                        </li>
                                                    <?php endforeach; ?>
                                            ...
                                            <div class="comments__list-wrapper">
                                                    ...
                                                    <li class="comments__item user">
                                                        ...
                                                        <div class="comments__info">
                                                            <div class="comments__name-wrapper">
                                                                ...
                                                                ><?= format_publication_date($comment['date_add']) ?>
                                                                </time>
                                                            </div>
                                                ...
                                                <?php if ($comments_count > 2 && count($comments) <= 2) : ?>
                                                    <a
                                                        ...
                                                        <sup class="comments__amount"
                                                        ><?= $comments_count - 2 ?></sup>
                                                    </a>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                        ...
                                        <form class="comments__form form"
                                              action="profile.php?user_id=<?= $user_id ?>" method="post">
                                            ...
                                            <div class="form__input-section <?= isset($errors['message'])
                                    ...
                                    <li class="post-mini post-mini--<?= $like['content_type'] ?> post user">
                                        <div class="post-mini__user-info user__info">
                                            ...
                                            <div class="post-mini__name-wrapper user__name-wrapper">
                                                ...
                                                <span
                                                        class="post-mini__activity user__additional"
                                                >Лайкнул вашу публикацию</span>
                                        ...
                                        <div class="post-mini__preview">
                                            <a class="post-mini__link"
                                               href="<?= utils_url_to('post', ['ID' => $like['post_id']]) ?>"
                                               title="Перейти на публикацию">
                                                ...
                                                <?php elseif ($like['content_type'] == 'text') : ?>
                                                    ...
                                                    <svg class="post-mini__preview-icon" width="20" height="21">
                                                        <use xlink:href="/img/sprite.svg#icon-filter-text"></use>
                                                    </svg>
                                                <?php elseif ($like['content_type'] == 'video') : ?>
                                                    <div class="post-mini__image-wrapper">
                                                        <img class="post-mini__image"
                                                             src="<?= get_youtube_video_miniature($like['content']) ?>"
                                                             width="109" height="109" alt="Превью публикации">
                                                ...
                                                <?php elseif ($like['content_type'] == 'quote') : ?>
                                                    ...
                                                    <svg class="post-mini__preview-icon" width="21" height="20">
                                                        <use xlink:href="/img/sprite.svg#icon-filter-quote"></use>
                                                    </svg>
                                                <?php elseif ($like['content_type'] == 'link') : ?>
                                                    <span class="visually-hidden">Ссылка</span>
                                                    <svg class="post-mini__preview-icon" width="21" height="18">
                                                        <use xlink:href="/img/sprite.svg#icon-filter-link"></use>
                                                    </svg>
                                                <?php endif; ?>
                                            </a>
                                        </div>
                                            ...
                                            <div class="post-mini__rating user__rating">
                                                ...
                                                ><?= $subscription['post_count'] ?></span>
                                                    <span class="post-mini__rating-text user__rating-text">
                                                        <?= format_text_publications($subscription['post_count']) ?>
                                                    </span>
                                                </p>
                                                <p class="post-mini__rating-item
                                                user__rating-item
                                                user__rating-item--subscribers">
                                                <span class="post-mini__rating-amount user__rating-amount"
                                                ><?= $subscription['subscription_count'] ?></span>
                                                    <span class="post-mini__rating-text user__rating-text">
                                        <?= format_text_followers($subscription['subscription_count']) ?>
                                                </span>
                                                </p>
                                            </div>
                                            <div class="post-mini__user-buttons user__buttons">
                                                <?php if ($subscription['user_id'] !== $actual_user_id) : ?>
                                                    ...
                                                    <?php if ($your_subscribe) : ?>
                                                        <a
                                                                href="<?= utils_url_to('subscription', [
                                                                    'user_id' => $subscription['user_id'],
                                                                    'follower_id' => $actual_user_id,
                                                                    'action' => 'remove'
                                                                ]) ?>"
                                                                class="post-mini__user-button
                                                        user__button
                                                        user__button--subscription
                                                        button button--quartz">Отписаться</a>
                                                    <?php else : ?>
