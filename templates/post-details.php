        ...
        <section class="post-details">
            ...
            <div class="post-details__wrapper post-photo">
                <div class="post-details__main-block post post--details">
                    ...
                    <div class="post__indicators">
                        <div class="post__buttons">
                            ...
                            <a class="post__indicator post__indicator--repost button"
                               href="<?= utils_url_to('repost', ['ID' => $post['id']]) ?>" title="Репост">
                                <svg class="post__indicator-icon" width="19" height="17">
                    ...
                    <?php endif; ?>
                    <div class="comments">
                        <form class="comments__form form" action="<?= utils_url_to('post', [
                            'ID' => $post_id
                        ]) ?>"
                              method="post">
                            <div class="comments__my-avatar">
                                <?php if ($user['avatar']) : ?>
                                    <img class="comments__picture" src="<?= $user['avatar'] ?>"
                                         alt="Аватар пользователя">
                                <?php endif; ?>
                            </div>
                            <div class="form__input-section <?= !empty($errors) && $errors['message']
                ...
                <div class="post-details__user user">
                    <div class="post-details__user-info user__info">
                        <div class="post-details__avatar user__avatar">
                            <a class="post-details__avatar-link user__avatar-link"
                               href="<?= utils_url_to('profile', ['user_id' => $author_info['id']]) ?>">
                    ...
                    <div class="post-details__rating user__rating">
                        <p class="post-details__rating-item user__rating-item user__rating-item--subscribers">
                            ...
                            ><?= $author_info['count_followers'] ?></span>
                            <span class="post-details__rating-text user__rating-text"
                            ><?= get_text_count_followers($author_info['count_followers']) ?></span>
                        </p>
                        <p class="post-details__rating-item user__rating-item user__rating-item--publications">
                            <span class="post-details__rating-amount user__rating-amount"
                            ><?= $author_info['count_posts'] ?></span>
                            <span class="post-details__rating-text user__rating-text"
                            ><?= get_text_count_publications($author_info['count_posts']) ?></span>
                        </p>
                    </div>
                        ...
                        <div class="post-details__user-buttons user__buttons">
                            ...
                            <?php if ($your_subscribe) : ?>
                                <a
                                        ...
                                        class="user__button user__button--subscription button button--quartz"
                                >Отписаться</a>
                            <?php else : ?>
                                <a
                                        href="<?= utils_url_to('subscription', [
                            ...
                            <a class="user__button user__button--writing button button--green"
                               href="<?= utils_url_to('messages', ['user' => $author_info['id']]) ?>">Сообщение</a>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
